...
async function main() {
    ...
    try {
        ...
        let categories = ['lunch', 'drinks', 'desserts'].map((category) => { return { name: category } });
        ...
        let imageUrls = [
            ...
            'https://res.cloudinary.com/ddw5lodan/image/upload/v1700520472/ux4mb2uddegkcfrqmvjw.jpg',
        ]
